import {
  ...
  SkHynixArbitragePositionsResponseSchema,
  ...
  type SkHynixArbitrageCapabilities,
  type SkHynixArbitrageOpportunitiesResponse,
  type SkHynixArbitrageOpportunityQuery,
  type SkHynixArbitragePositionsResponse,
  type SkHynixArbitragePreview,
  type SkHynixArbitragePreviewRequest,
  type SkHynixArbitrageSpec,
  type StrategyConfig,
  type StrategyLog,
  type StrategyRecord,
...
export const api = {
  skHynixArbitrageCapabilities: () => request(
    SkHynixArbitrageCapabilitiesSchema,
    '/api/sk-hynix-arbitrage/capabilities',
  ),
  skHynixArbitrageSpec: () => request(SkHynixArbitrageSpecSchema, '/api/sk-hynix-arbitrage/spec'),
  skHynixArbitrageOpportunities: (query: SkHynixArbitrageOpportunityQuery) => request(
    SkHynixArbitrageOpportunitiesResponseSchema,
    '/api/sk-hynix-arbitrage/opportunities/query',
    {
      method: 'POST',
      headers: { 'x-gct-read-intent': 'sk-hynix-arbitrage-opportunities' },
      body: JSON.stringify(SkHynixArbitrageOpportunityQuerySchema.parse(query)),
    },
  ),
  skHynixArbitragePreview: (preview: SkHynixArbitragePreviewRequest) => request(
    SkHynixArbitragePreviewSchema,
    '/api/sk-hynix-arbitrage/previews',
    {
      method: 'POST',
      headers: { 'x-gct-read-intent': 'sk-hynix-arbitrage-preview' },
      body: JSON.stringify(SkHynixArbitragePreviewRequestSchema.parse(preview)),
    },
  ),
  skHynixArbitragePositions: () => request(
    SkHynixArbitragePositionsResponseSchema,
    '/api/sk-hynix-arbitrage/positions',
  ),
